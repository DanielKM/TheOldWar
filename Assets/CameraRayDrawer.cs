...
public class CameraRayDrawer : MonoBehaviour
{
    Camera cam;
    ...
    void Update()
    {
        Ray topLeftCorner = cam.ScreenPointToRay(new Vector3(0f, 0f));
        Ray topRightCorner = cam.ScreenPointToRay(new Vector3(Screen.width, 0f));
        Ray bottomLeftCorner = cam.ScreenPointToRay(new Vector3(0, Screen.height));
        Ray bottomRightCorner = cam.ScreenPointToRay(new Vector3(Screen.width, Screen.height));
