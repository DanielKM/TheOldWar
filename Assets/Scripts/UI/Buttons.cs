...
public class Buttons : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        workerResourcesButton.onClick.AddListener(delegate{UI.WorkerResourcesBuildings();});
        ...
        workerResourcesBackButton.onClick.AddListener(delegate{UI.WorkerSelect();});
    }
